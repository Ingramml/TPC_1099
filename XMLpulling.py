    ...
    if os.path.isfile(filecheck):
        ...
        if ET.iselement(ScheduleI) == True and ET.iselement(ScheduleI.find('{http://www.irs.gov/efile}RecipientTable')):
            ...
            for recipient in RecipientTablelist:
                ...
                business_name = business_name_check.text.upper() if ET.iselement(
                    business_name_check) == True else business_name_check3.text.upper() if ET.iselement(
                    business_name_check3) == True else business_name_check2.text.upper() if ET.iselement(
